...
const RISK_RULES: Array<{
  ...
  // 日常低风险善行 —— 优先匹配，防止被后续高风险规则误匹配
  {
    category: '日常善行',
    keywords: [
      '拾金不昧', '捡钱包', '捡手机', '捡到东西', '归还失主', '交给警察',
      '失物招领', '让座', '给老人让座', '给孕妇让座', '捐款', '捐物',
      '献血', '志愿者', '义工', '捡垃圾', '垃圾分类', '植树', '浇花',
      '喂流浪猫', '喂流浪狗', '帮按电梯', '帮开门', '指路', '维持秩序',
      '帮邻居', '帮同事', '帮同学', '帮老人拎', '帮小孩', '引导',
    ],
    level: 'low',
    advice: [
      '日常善行温暖人心，无需特别防护',
  ...
  {
    category: '交通救助',
    keywords: ['车祸', '交通事故', '撞人', '被撞', '闯红灯', '扶车', '推车', '交通意外', '路障', '追尾', '剐蹭', '肇事', '逃逸', '车辆侧翻', '抛锚', '爆胎'],
    level: 'high',
    advice: [
      '交通场景风险较高，建议录像存证',
      '注意自身安全，避免二次事故',
  ...
  {
    category: '水域救援',
    keywords: ['溺水', '落水', '跳河', '池塘', '湖', '河', '游泳', '救上来', '溺亡', '水塘', '水库', '淹水', '护城河', '沟渠', '河中', '湖中', '江中', '海里', '海浪', '潮汐', '离岸流', '漩涡', '抽筋'],
    level: 'high',
    advice: [
      '水域救援风险极高，优先呼叫专业救援',
      '不具备专业能力时，使用长杆/绳索等工具',
